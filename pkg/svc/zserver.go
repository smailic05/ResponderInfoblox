...
//
// TODO: Extend the MyResponder service by defining new RPCs and
...
//
// TODO: Create an implementation of the MyResponder server
...
// implementation of MyResponder server interface service, but only
...
func NewBasicServer() (pb.MyResponderServer, error) {
	return &server{}, nil
}
